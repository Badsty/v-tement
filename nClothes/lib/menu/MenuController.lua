...
function RageUI.DisableControls()
        ...
        if CurrentMenu() then
            if CurrentMenu.Open then
                ...
                if CurrentMenu.EnableMouse then
                    ...
                    if Controls.RightClick.Enabled then
                        for Index = 1, #Controls.RightClick.Keys do
                            if not Controls.RightClick.Pressed then
                                if IsDisabledControlJustPressed(Controls.RightClick.Keys[Index][1], Controls.RightClick.Keys[Index][2]) then
                                    Controls.RightClick.Pressed = true
                                    Citizen.CreateThread(function()
                                        Controls.RightClick.Active = true
                                        Citizen.Wait(1)
                                        Controls.RightClick.Active = false
                                        while Controls.RightClick.Enabled and IsDisabledControlPressed(Controls.RightClick.Keys[Index][1], Controls.RightClick.Keys[Index][2]) do
                                            Controls.RightClick.Active = true
                                            Citizen.Wait(1)
                                            Controls.RightClick.Active = false
                                        end
                                        Controls.RightClick.Pressed = false
                                    end)
                                    break
                                end
                            end
        ...
        if CurrentMenu() and (CurrentMenu.Display.Navigation) then
            ...
            if RageUI.Options > CurrentMenu.Pagination.Total then
                ...
                if CurrentMenu.EnableMouse then
                    ...
                    if CurrentMenu.Controls.RightClick.Active then
                        if UpHovered then
                            RageUI.GoUp(RageUI.Options)
                        elseif DownHovered then
                            RageUI.GoDown(RageUI.Options)
