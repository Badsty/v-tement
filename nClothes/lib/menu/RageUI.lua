...
RageUI.Settings = {
    ...
    Items = {
        Title = {
            Background = { Width = 431, Height = 85 },
            Text = { X = 215, Y = 12, Scale = 0.8 },
        },
        Subtitle = {
            Background = { Width = 431, Height = 35 },
        ...
        if CurrentMenu() and (CurrentMenu.Display.Header) then
            ...
            if CurrentMenu.Sprite ~= nil then
                if CurrentMenu.Sprite.Dictionary ~= nil then
                    ...
                    RenderRectangle(CurrentMenu.X, CurrentMenu.Y, RageUI.Settings.Items.Title.Background.Width + CurrentMenu.WidthOffset, RageUI.Settings.Items.Title.Background.Height,CurrentMenu.Rectangle.R or 0, CurrentMenu.Rectangle.G or 0, CurrentMenu.Rectangle.B or 0, CurrentMenu.Rectangle.A or 100)
                end
            else
            ...
            --if (CurrentMenu.Display.Glare) then
                ...
                ---@type number
                local GlareY = CurrentMenu.Y / 1080 + CurrentMenu.SafeZoneSize.Y / 41.5
            ...
            --CurrentMenu:SetRectangleBanner(waveArena.MenuColor.R, waveArena.MenuColor.G, waveArena.MenuColor.B, 150) --starlife
        end
    end
end
