...
function RageUI.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.Index = 1
    Menu.Sprite = {Color = { R = tonumber(R) or 255, G = tonumber(G) or 255, B = tonumber(B) or 255, A = tonumber(A) or 255 } }
    Menu.Rectangle = { R = tonumber(R) or 0, G = tonumber(G) or 0, B = tonumber(B) or 0, A = tonumber(A) or 100 }
